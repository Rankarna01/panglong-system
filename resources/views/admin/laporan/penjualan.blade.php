...
<div class="space-y-6">
    <div class="flex justify-between items-center print:hidden">
        ...
        <div class="flex gap-2">
            <a href="{{ route('admin.laporan.penjualan.export', ['format' => 'pdf']) }}" class="bg-red-50 text-red-600 border border-red-100 px-4 py-2.5 rounded-xl hover:bg-red-500 hover:text-white transition flex gap-2 text-sm font-bold"><i class="fas fa-file-pdf mt-0.5"></i> PDF</a>
            <a href="{{ route('admin.laporan.penjualan.export', ['format' => 'excel']) }}" class="bg-emerald-50 text-emerald-600 border border-emerald-100 px-4 py-2.5 rounded-xl hover:bg-emerald-500 hover:text-white transition flex gap-2 text-sm font-bold"><i class="fas fa-file-excel mt-0.5"></i> Excel</a>
        </div>
    </div>
